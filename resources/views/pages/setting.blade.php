        ...
        <div class="flex justify-between items-center ">
            ...
            <div class="h-screen w-1/3 bg-gray-900">
                ...
                <div class="w-3/5 mx-auto h-3/4 pt-20">
                    <div class="border-4 border-gray-200 overflow-y-auto rounded-3xl h-full p-3" style="background: url('{{$user->layout->bgImage}}');background-size: cover; " >
                        ...
                        <div class="social-links mt-6 grid grid-cols-2 gap-4 h-2/4">
